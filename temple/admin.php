        ...
        <div class="container-fluid booking py-5">
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        <h1 class="text-white mb-3">管理員登入</h1>
                        <!-- <a href="./reg.php" class="btn btn-primary rounded-pill py-2 px-4 ms-lg-4 text-warning mb-4" onclick="location.href='?do=reg'"></a> -->
                        ...
                        <form>
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <button onclick="login('admin')" type="button" class="btn btn-primary rounded-pill position-absolute top-0 end-0 py-2 px-4 mt-2 me-2">登入</button>
                                    </div>
                                </div>
                                <div class="col-md-6">
